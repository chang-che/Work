...
for (i in 1:nloop) 
{
  ...
  lamL1.v = exp(seq(log(10),log(70), length=30)) 
  lamL2.v = seq(0,40, length=30)
  ...
  listoflambdas2[[i]] = list(lamL1.pick, lamL2.pick)
...
pdf(file = "/export/home/chche/WTC_Project/Results/test_10*3:7_v4.pdf")
