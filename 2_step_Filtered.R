...
####################################################################################################
load(file = '/export/home/chche/WTC_Project/Data/match_sign_genes_MDD.Rdata')
load(file = '/export/home/chche/WTC_Project/Data/match_sign_genes_PHQ9.Rdata')
...
respond <- c('MDD','PHQ9')
batch_num <- c(3, 4)
pdf(file = "/export/home/chche/WTC_Project/Results/mean_sd_2step_filtered.pdf")
...
for(i in 1:2){
  ...
  for(j in 1:2){
    ...
    batch_gene_filter <- intersect(batch_gene_filter, colnames(exon.norm.log.mad))
    repsonse <- respond[j]
